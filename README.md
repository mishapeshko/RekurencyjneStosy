...
2) Strong Exception Safety: The library guarantees no memory leaks and maintains state integrity even if underlying memory allocations (`malloc`, `calloc`) fail.
